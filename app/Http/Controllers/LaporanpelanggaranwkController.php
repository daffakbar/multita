...
class LaporanpelanggaranwkController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('walikelass.laporanpelanggaran.index', compact('pilihkelas', 'kelas'));
    }
    public function cetakpdf(Request $request)
    {
        ...
        // dd($ta);   
        set_time_limit(500);
        $pdf = PDF::loadview('walikelass.laporanpelanggaran.cetakpdf',['pilihkelas'=>$pilihkelas, 'kelas'=>$kelas, 'ta'=>$ta]);
        return $pdf->stream();
    }
