...
class LaporanprestasiwkController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('walikelass.laporanprestasi.index', compact('pilihkelas', 'kelas'));
    }
    ...
    public function cetakpdf(Request $request)
    {
        ...
        // dd($ta);   
        set_time_limit(500);
        $pdf = PDF::loadview('walikelass.laporanprestasi.cetakpdf',['pilihkelas'=>$pilihkelas, 'kelas'=>$kelas, 'ta'=>$ta]);
        return $pdf->stream();
    }
    /**
