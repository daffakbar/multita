...
<html lang="en">
  <head>
    ...
    {{-- SCRIPT TABULATOR JS & DOWNLOAD PDF --}}
    ...
    <div class="page-body">
      ...
      <div class="sidebar">
        ...
        <ul class="navigation-menu">
          ...
          <li>
            <a href="{{ url('walikelass/dashboard') }}">
          ...
          <li>
            ...
            <ul class="collapse navigation-submenu" id="sample-pages1">
              <li>
                <a href="{{ url('walikelass/laporanpelanggaran') }}" >Laporan pelanggaran</a>
              </li>
              <li>
                <a href="{{ url('walikelass/laporanprestasi') }}" >Laporan prestasi</a>
              </li>
            </ul>
          </li>
