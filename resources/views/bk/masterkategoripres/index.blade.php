                  ...
                  <div class="item-wrapper">
                    <form action="{{ url('bk/masterkategoripres/tambah') }}" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="kategoripres" placeholder="" required>
                      </div>
                  </div>
                </div>
              </div>
                ...
                <div class="grid">
                    ...
                    <div class="item-wrapper">
                        <div class="table-responsive">
                            ...
                            {{ $kategoripres->links() }}
                            Halaman : {{ $kategoripres->currentPage() }} <br/>
                            Jumlah Data : {{ $kategoripres->total() }} <br/>
                            Data Per Halaman : {{ $kategoripres->perPage() }} <br/>
                        </div>
                    </div>
                </div>
            </div>
